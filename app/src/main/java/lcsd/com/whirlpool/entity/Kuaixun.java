...
public class Kuaixun {
    public static class TRslist{
        ...
        private	String	id;	/*1863*/
        private	String	hits;	/*1*/
        private	String	title;	/*新品快讯*/
        private	String	attr;	/**/
        private	String	dateline;	/*1498658789*/
        private	String	thumb;	/**/
        private	String	url;	/*http://huierpu.5kah.com/index.php?id=1863*/
        private	String	note;	/*新品快讯*/
