 ...
 */
//无进度条播放器
public class StandardGSYVideoPlayer1 extends GSYVideoPlayer {
    ...
    private boolean mIssetbaryc=true; //是否隐藏进度条默认隐藏
    private boolean mIsJfbar=true;//是否隐藏积分图标默认隐藏
     ...
     */
    public StandardGSYVideoPlayer1(Context context, Boolean fullFlag) {
        super(context, fullFlag);
    }

    public StandardGSYVideoPlayer1(Context context) {
        super(context);
    }

    public StandardGSYVideoPlayer1(Context context, AttributeSet attrs) {
        super(context, attrs);
    }
    ...
    protected void init(Context context) {
        ...
        mJf= (ImageView) findViewById(R.id.getpoints);
    ...
    public GSYBaseVideoPlayer startWindowFullscreen(Context context, boolean actionBar, boolean statusBar) {
        ...
        if (gsyBaseVideoPlayer != null) {
            StandardGSYVideoPlayer1 gsyVideoPlayer = (StandardGSYVideoPlayer1) gsyBaseVideoPlayer;
     ...
     * 全屏的UI逻辑
     */
    private void initFullUI(StandardGSYVideoPlayer1 standardGSYVideoPlayer) {
     ...
     * @return
     */
    public boolean ismIssetbaryc() {
        return mIssetbaryc;
    }

    public void setmIssetbaryc(boolean mIssetbaryc) {
        this.mIssetbaryc = mIssetbaryc;
    }
     ...
     * @return
     */
    public boolean ismIsJfbar() {
        return mIsJfbar;
    }

    public void setmIsJfbar(boolean mIsJfbar) {
        this.mIsJfbar = mIsJfbar;
    }
    /**
     * 获得播放进度
     * @return 当前的播放进度
